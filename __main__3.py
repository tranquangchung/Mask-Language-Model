...
from driver import BERTTrainer, BERTTrainerStyle
from transformer import Encoder, Encoder_StyleSpeech
...
def train():
    ...
    vocab_size = 1051
    bert = Encoder_StyleSpeech(model_config)
    print("Creating BERT Trainer")
    trainer = BERTTrainerStyle(bert, vocab_size, train_dataloader=train_data_loader, test_dataloader=valid_data_loader,
                          with_cuda=args.with_cuda, cuda_devices=args.cuda_devices, args=args, path=paths, model_config=model_config)
